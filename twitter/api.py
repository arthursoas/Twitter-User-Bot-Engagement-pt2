...
class Api(object):
    ...
    def GetSearch(self,
        ...
        url = "{0}/search/tweets.json".format(self.base_url)
        parameters = {}
        if since_id:
    ...
    def GetRepliesToUser(self,
                  screen_name_bot=None,
                  screen_name_user=None,
                  geocode=None,
                  since_id=None,
                  max_id=None,
                  until=None,
        ...
        if screen_name_user is not None:
            url = "{0}/search/tweets.json?q=to%3A{1}%20from%3A{2}".format(self.base_url, screen_name_bot,
                                                                          screen_name_user)
        else:
            url = "{0}/search/tweets.json?q=to%3A{1}".format(self.base_url, screen_name_bot)
        ...
        # if screen_name_bot is None or screen_name_user is None:
        #     return []
    ...
    def GetUserTimeline(self,
        ...
        parameters = {
            'tweet_mode': enf_type('tweet_mode', str, 'extended')
        }
    ...
    def GetStatus(self,
        ...
        parameters = {
            ...
            'tweet_mode':enf_type('tweet_mode', str, 'xtended')
        }
